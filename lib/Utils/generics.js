...
const generateMessageID = () =>
  "ILSYM-" + (0, crypto_1.randomBytes)(6).toString("hex").toUpperCase();
...
const fetchLatestBaileysVersion = async (options = {}) => {
  const URL =
    "https://raw.githubusercontent.com/SiX-CoRe/Bailyes/refs/heads/main/lib/Defaults/baileys-version.json";
  try {
