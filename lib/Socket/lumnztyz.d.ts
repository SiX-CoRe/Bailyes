...
declare namespace lumnztyz {
  ...
  interface Utils {
    prepareWAMessageMedia: (
      media: any,
      options: WAMessageContentGenerationOptions
    ) => Promise<any>;
...
declare class lumnztyz {
  constructor(
    utils: lumnztyz.Utils,
    waUploadToServer: lumnztyz.WAMediaUploadFunction,
    relayMessageFn?: (jid: string, content: any, options?: any) => Promise<any>
  );

  detectType(
    content: lumnztyz.MessageContent
  ):
    | "PAYMENT"
    | "PRODUCT"
    | "INTERACTIVE"
  ...
  handlePayment(
    content: { requestPaymentMessage: lumnztyz.PaymentMessage },
    quoted?: proto.IWebMessageInfo
  ): Promise<{ requestPaymentMessage: proto.Message.RequestPaymentMessage }>;

  handleProduct(
    content: { productMessage: lumnztyz.ProductMessage },
    jid: string,
    quoted?: proto.IWebMessageInfo
  ): Promise<{ viewOnceMessage: proto.Message.ViewOnceMessage }>;

  handleInteractive(
    content: { interactiveMessage: lumnztyz.InteractiveMessage },
    jid: string,
    quoted?: proto.IWebMessageInfo
  ): Promise<{ interactiveMessage: proto.Message.InteractiveMessage }>;

  handleAlbum(
    content: { albumMessage: lumnztyz.AlbumItem[] },
    jid: string,
    quoted?: proto.IWebMessageInfo
  ): Promise<any>;

  handleEvent(
    content: { eventMessage: lumnztyz.EventMessage },
    jid: string,
    quoted?: proto.IWebMessageInfo
  ): Promise<any>;

  handlePollResult(
    content: { pollResultMessage: lumnztyz.PollResultMessage },
    jid: string,
    quoted?: proto.IWebMessageInfo
  ): Promise<any>;

  handleGroupStory(
    content: { groupStatusMessage: lumnztyz.GroupStatusMessage },
    jid: string,
    quoted?: proto.IWebMessageInfo
  ): Promise<any>;
  ...
  buildMessageContent(
    content: any,
    opts?: lumnztyz.WAMessageContentGenerationOptions
  ): Promise<any>;

  utils: lumnztyz.Utils;
  relayMessage: (jid: string, content: any, options?: any) => Promise<any>;
  waUploadToServer: lumnztyz.WAMediaUploadFunction;
  bail: lumnztyz.BailUtils;
}
